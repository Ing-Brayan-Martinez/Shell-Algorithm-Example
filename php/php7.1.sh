...
sudo apt purge php7.1 php7.1-dev php7.1-cli php7.1-fpm php7.1-cgi php7.1-bcmath php7.1-bz2 \
    ...
    php7.1-xml php7.1-phpdbg libapache2-mod-php7.1 && sudo apt autoremove
