sudo apt -y purge php5.6 php5.6-dev php5.6-cli php5.6-fpm php5.6-cgi php5.6-bcmath php5.6-bz2 \
    ...
    php5.6-xml php5.6-phpdbg libapache2-mod-php5.6 && sudo apt -y autoremove